...
SOURCE_SHEET = "Sheet1"
SOURCE_FILE_CSV = "Data.csv"
CSV_SEP = ","
COLUMN_X = "System area"
COLUMN_Y = "Fault Group Duration"
COLUMN_Z = "Fault Group Time Difference"
COLOR_CODING_DIMENSION = "Shift headcount"
...
def main():
    ...
    print_all_col_names_to_console(df)
    ...
    app.layout = html.Div([
        ...
        dcc.Graph(
            id="scatter-3d",
            figure=build_3d_figure(df, COLUMN_X, COLUMN_Y, COLUMN_Z, COLOR_CODING_DIMENSION)
        )
    ])
